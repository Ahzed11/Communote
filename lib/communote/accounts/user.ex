defmodule Communote.Accounts.User do
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :password, :first_name, :last_name, :roles])
    |> validate_email()
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Communote.Repo)
  ...
  """
  def valid_password?(%Communote.Accounts.User{hashed_password: hashed_password}, password)
